...
if __name__=='__main__':
    ...
    for (nonlearned_index, nonlearned_row) in nonlearned_hyperparameters.iterrows():
        ...
        torch.save(train_losses, f'./nonlearned_train_basin_random_state={random_state}.pth')
    ...
    for (learned_index, learned_row) in learned_hyperparameters.iterrows():
        ...
        train_losses = torch.tensor(train_losses)
        val_or_test_losses = torch.tensor(val_or_test_losses)
        torch.save(train_losses, f'./learned_train_basin_random_state={random_state}.pth')
        torch.save(val_or_test_losses, f'./learned_test_basin_random_state={random_state}.pth')        