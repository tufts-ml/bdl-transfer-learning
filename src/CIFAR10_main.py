...
if __name__=='__main__':
    ...
    if args.prior_type == 'nonlearned':
        ...
        loc = torch.load(f'{args.prior_path}/resnet50_torchvision_mean.pt')
        ...
        loc = torch.load(f'{args.prior_path}/resnet50_torchvision_mean.pt')
        cov_factor = torch.load(f'{args.prior_path}/resnet50_torchvision_covmat.pt')
        cov_factor = args.prior_scale * (cov_factor[:args.number_of_samples_prior]) # Scale the low rank covariance
        cov_diag = torch.load(f'{args.prior_path}/resnet50_torchvision_variance.pt')
