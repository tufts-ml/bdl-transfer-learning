...
if __name__=='__main__':
    ...
    augmented_train_dataset, train_dataset, val_or_test_dataset = utils.get_aircrafts_datasets(root=args.dataset_path, n=args.n, tune=args.tune, random_state=args.random_state)
    # PyTorch DataLoaders
